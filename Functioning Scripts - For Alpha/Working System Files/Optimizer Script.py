...
settings = {
    ...
    'iters': 70,
    'n_particles': 200,
    'bounds': (np.ones(3)*lower_b, np.ones(3)*upper_b) # Bounds between [-5, 5] for x1, x2
}
